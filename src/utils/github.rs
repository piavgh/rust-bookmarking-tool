...
mod tests {
    ...
    fn test_construct_github_profile_url_with_repo_url() {
        let fake_query = "gh piavgh";

        assert_eq!(construct_github_url(fake_query), "https://github.com/piavgh");
    }

    #[test]
    fn test_construct_github_search_url_with_repo_url() {
        let fake_query = "gh piavgh/rust-bookmarking-tool";

        assert_eq!(construct_github_url(fake_query), "https://github.com/piavgh/rust-bookmarking-tool");
    }
}
